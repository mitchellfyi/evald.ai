  ...
  module Adapters
    class OpenrouterAdapterTest < ActiveSupport::TestCase
      ...
      test "fetches and normalizes models from OpenRouter API" do
        ...
        @adapter.stubs(:fetch_json).returns(mock_response)
      ...
      test "handles empty response" do
        @adapter.stubs(:fetch_json).returns({ "data" => [] })
      ...
      test "handles API errors gracefully" do
        @adapter.stubs(:fetch_json).raises(BaseAdapter::FetchError.new("API error"))
